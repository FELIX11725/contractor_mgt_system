<div>
    <div class="p-4">
        <div class="w-full bg-white border border-gray-200 rounded-xl shadow-xl dark:bg-gray-800 dark:border-gray-700 overflow-hidden">
            <div class="flex flex-wrap justify-between items-center border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 px-8 py-6">
            ...
            <div class="p-8 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
                <!-- Project -->
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 hover:shadow-lg transition-shadow duration-300">
                    ...
                    <p class="text-gray-600 dark:text-gray-400 font-medium pl-7">{{ $budget->phase->project->project_name }}</p>
                </div>
                ...
                <!-- Description -->
                <div class="bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 p-5 rounded-xl shadow-md border border-gray-200 dark:border-gray-700 col-span-1 sm:col-span-2 lg:col-span-2 hover:shadow-lg transition-shadow duration-300">
                    <h5 class="text-lg font-semibold text-gray-800 dark:text-gray-300 flex items-center gap-2 mb-2">
        ...
        <div
            ...
            <section class="container px-4 mx-auto">
                ...
                <div class="px-8 py-6 border-b border-gray-200 dark:border-gray-700 bg-gradient-to-r from-blue-50 to-white dark:from-gray-800 dark:to-gray-900 flex justify-between items-center">
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                    <thead class="bg-gray-50 dark:bg-gray-800">
                                        <tr>
                                            ...
                                            <th scope="col" class="px-6 py-4 text-sm font-semibold text-left rtl:text-right text-gray-700 dark:text-gray-300 uppercase tracking-wider relative" x-data="{ showTooltip: false }">
                                                <div class="flex items-center">
                                                    <span>Forecast Amount</span>
                                                    <span class="ml-1 text-gray-500 cursor-pointer" @mouseover="showTooltip = true" @mouseleave="showTooltip = false">
                                                ...
                                                <!-- Tooltip -->
                                                <div x-show="showTooltip" class="absolute left-0 mt-2 w-64 p-3 text-xs text-white bg-gray-900 rounded-lg shadow-lg z-10" style="display: none;">
                                                    The Forecast Amount is the total amount if all requested expenses were fully approved.
                                                </div>
                                            </th>
    
                                            <th scope="col" class="px-6 py-4 text-sm font-semibold text-left rtl:text-right text-gray-700 dark:text-gray-300 uppercase tracking-wider">
                                                Total Spent
                                            </th>
                                            ...
                                            <tr class="hover:bg-gray-50 dark:hover:bg-gray-800 transition-colors duration-200">
                                                <td class="px-6 py-4 text-sm font-medium text-gray-700 dark:text-gray-200 whitespace-nowrap">
                                                    <div class="inline-flex items-center gap-x-3">
                                                        <input type="checkbox" class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500 dark:bg-gray-700 dark:border-gray-600">
                                                ...
                                                <td class="px-6 py-4 text-sm text-gray-600 dark:text-gray-300 whitespace-nowrap font-medium">
                                                    {{ $item->quantity }}
                                                </td>
                                                ...
                                                <td class="px-6 py-4 text-sm whitespace-nowrap">
                                                    <div class="font-medium text-green-600 dark:text-green-400">
                                                        {{ number_format($item->approved_expenses_sum_amount_paid ?? 0, 0, '.', ',') }}
                                                    </div>
                                                </td>
                                            ...
                                            <tr>
                                                <td colspan="7" class="px-6 py-8 text-center">
                                                    <div class="flex flex-col items-center justify-center">
                                                        ...
                                                        <p class="text-gray-500 dark:text-gray-400 text-lg font-medium">No budget items found</p>
                                                        <p class="text-gray-400 dark:text-gray-500 text-sm mt-1">Click "New Budget Item" to add one</p>
                                                    </div>
                                                </td>
                                            </tr>
                                        @endforelse
