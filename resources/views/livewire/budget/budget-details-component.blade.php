            ...
            <section class="container px-4 mx-auto">
                ...
                <div class="flex items-center gap-x-3">
                    <button wire:click="exportToPdf"
                      class="ml-auto px-4 py-2 text-sm font-medium text-white bg-green-600 rounded-lg hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-green-500 dark:bg-gray-800 dark:text-green-400 dark:hover:bg-gray-700 flex items-center gap-2">
                    ...
                    class="px-4 py-2 text-sm font-medium text-white bg-blue-600 rounded-lg hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-800 dark:text-blue-400 dark:hover:bg-gray-700 flex items-center gap-2">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M12 4.5v15m7.5-7.5h-15" />
                    </svg>
                    New Budget <Item></Item>
                </button>
                </div>
                                ...
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                        ...
                                        <tr>
                                            ...
                                            <th scope="col"
                                                ...
                                                <div x-show="showTooltip"
                                                    class="absolute left-0 mt-2 w-64 p-2 text-xs text-white bg-gray-900 rounded-lg shadow-lg"
                                                    style="display: none;">
                                    ...
                                    <tbody
                                            ...
                                            <tr>
                                                ...
                                                <td class="px-4 py-4 text-sm whitespace-nowrap">
                                                    <div class="flex items-center gap-x-4">
                                                        ...
                                                        <button
                                                            wire:click="openEditBudgetItemModal({{ $item->id }})"
                                                        ...
                                                        <!-- Delete Button -->
                                                        <button
                                                            wire:click="openDeleteBudgetItemModal({{ $item->id }})"
                                        ...
                                        @empty
                                            <tr>
                                                <td colspan="6"
                                                    class="text-center py-4 text-gray-500 dark:text-gray-300">No
