        ...
        <div
            ...
            <section class="container px-4 mx-auto">
                        ...
                        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
                            <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                       ...
                                       <tr >
                                                ...
                                                <div class="flex items-center gap-x-2">
                                                    ...
                                                    <div>
                                                        <h2 class="font-medium text-gray-800 dark:text-white ">
                                                            {{ $item->expenseCategoryItem?->name ?? "NaN" }}</h2>
                                                        <p
                                        ...
                                        <td class="px-4 py-4 text-sm whitespace-nowrap">
                                            <div class="flex items-center gap-x-4">
                                                <!-- Edit Button -->
                                                <button class="bg-blue-500 text-white px-4 py-2 rounded-lg transition-colors duration-200 hover:bg-blue-600 focus:outline-none flex items-center gap-2">
                                                ...
                                                <!-- Delete Button -->
                                                <button class="bg-red-500 text-white px-4 py-2 rounded-lg transition-colors duration-200 hover:bg-red-600 focus:outline-none flex items-center gap-2">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5">
                                                        <path stroke-linecap="round" stroke-linejoin="round"
                                    ...
                                    @empty
                                    <tr>
                                        <td colspan="6" class="text-center py-4 text-gray-500 dark:text-gray-300">No budget items found</td>
                                    </tr>
                                    @endforelse
                ...
                <div class="flex items-center justify-between mt-6">
                    <!-- Previous Button -->
                    <button wire:click="previousPage" class="flex items-center px-5 py-2 text-sm font-medium text-gray-700 capitalize transition-colors duration-200 bg-white border border-gray-300 rounded-lg gap-x-2 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700">
                    ...
                    <div class="items-center hidden lg:flex gap-x-2">
                        @if ($budgetItems->lastPage() > 1)
                            @for ($i = 1; $i <= $budgetItems->lastPage(); $i++)
                                <button wire:click="gotoPage({{ $i }})" class="px-3 py-1 text-sm font-medium rounded-lg transition-colors duration-200
                    ...
                    <!-- Next Button -->
                    <button wire:click="nextPage" class="flex items-center px-5 py-2 text-sm font-medium text-gray-700 capitalize transition-colors duration-200 bg-white border border-gray-300 rounded-lg gap-x-2 hover:bg-gray-100 dark:bg-gray-800 dark:text-gray-200 dark:border-gray-700 dark:hover:bg-gray-700">
                        <span>Next</span>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-5 h-5 rtl:-scale-x-100">
            ...
            <x-dialog-modal wire:model="showNewBudgetItemModal">
                ...
                <x-slot name="content">
                    ...
                    <div class="grid grid-cols-2 gap-4">
                        <!-- Expense Item -->
                        <div>
                            <label for="expense_category" class="block text-sm font-medium text-gray-700">Expense Category item <span class="text-red-500">*</span></label>
